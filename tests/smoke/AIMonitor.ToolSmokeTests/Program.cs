...
internal static class Program
{
    ...
    private static async Task<int> Main(string[] args)
    {
        ...
        Console.WriteLine("  --mcp-live-record-decision --staged-record-id <id> --decision accepted|rejected [--expected-staged-hash <hash>] Record the human review decision.");
    ...
    private static async Task<int> RunMcpLiveSyntaxRejectionAsync()
    {
        ...
        Console.WriteLine("Agent recovery contract: rewrite the Working candidate into valid C# and retry the edit; do not force a broken candidate through to review.");
