...
| [ClaudeWorkbench.Launcher](ClaudeWorkbench.Launcher.md) | WPF / WinForms (optional) | Two interchangeable UIs (WPF primary, WinForms fallback). Runs several workspaces side by side: a host+sidecar+browser per instance, one Job Object each |
